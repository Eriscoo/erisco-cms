...
const id: Locale = {
  ...
  home: {
    ...
    highlights: [
      { title: 'Pecinta Linux', description: 'Saya termasuk pecinta linux, terutama KDE.' },
      { title: 'React', description: 'Saya membangun UI modern dengan React & ekosistemnya.' },
      { title: 'Figma', description: 'Saya menyukai antarmuka yang bersih dan intuitif.' },
      { title: 'Golang', description: 'Saya menulis backend dan CLI tools yang cepat dengan Go, termasuk website ini.' },
  ...
  categoryPosts: {
    documentTitle: 'Semua Postingan Berdasarkan Kategori: {name} | Eriscoo',
    title: 'Semua Postingan Berdasarkan Kategori: {name}',
    description: 'Jelajahi postingan dalam kategori {name}.',
    breadcrumbLabel: 'Kategori',
    loadMore: 'Muat Lebih Banyak',
    noPosts: 'Belum ada postingan di kategori ini.',
    noPostsSub: 'Cek lagi nanti atau jelajahi kategori lainnya.',
    backToPosts: 'Jelajahi Semua Postingan',
    retry: 'Coba Lagi',
    failed: 'Gagal memuat postingan.',
  },
  tagPosts: {
    documentTitle: 'Semua Postingan Berdasarkan Tag: {name} | Eriscoo',
    title: 'Semua Postingan Berdasarkan Tag: {name}',
    description: 'Jelajahi postingan dengan tag {name}.',
    breadcrumbLabel: 'Tag',
    loadMore: 'Muat Lebih Banyak',
    noPosts: 'Belum ada postingan dengan tag ini.',
    noPostsSub: 'Cek lagi nanti atau jelajahi tag lainnya.',
    backToPosts: 'Jelajahi Semua Postingan',
    retry: 'Coba Lagi',
    failed: 'Gagal memuat postingan.',
  },
